	...
	const projectData = [
		{
			...
			description:
				"Developed a webapplication for Steunpunt Friesland to efficiently manage and filter over 200 care locations. Built using the TALL stack and Filament with Supabase for the backend.",
